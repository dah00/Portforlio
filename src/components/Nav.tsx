...
function Nav() {
  ...
  return (
    <div className='flex justify-around'>
        ...
        <div className='burger-menu flex flex-col justify-between h-6 cursor-pointer' onClick={toggleMenu}>
            <span className={`menu-bar ${burgerStyle}`}></span>
            <span className={`menu-bar ${burgerStyle}`}></span>
            <span className={`menu-bar ${burgerStyle}`}></span>
        </div>
        <ul className={`${menuVisibilty} list-none w-28 h-36 space-y-3 p-1 absolute right-12 top-20 shadow-md rounded-lg`}>
            <li>About</li>
            <li>Experience</li>
            <li>Projects</li>
            <li>Contact</li>
